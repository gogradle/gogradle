...
to perform a migration. This will tell Gogradle to read the dependency lock file generated by them automatically. You can generate Gogradle's own `gogradle.lock` later. See [Dependency Lock](#dependency-lock) for more details.
