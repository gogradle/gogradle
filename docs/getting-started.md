...
goInit will create "src" directory with golang-project-layout.
...
golang {
    ...
    buildTags = ['appengine','anothertag']
     //Where Gogradle will be looking for main application
     mainApplicationPath = 'github.com/my/packacge/com/appName/mainappdir'
     // If specified Gogradle will create "appName" directory in project layout e.g. ${rootProject}/src/my/package/cmd/appName
     applicationName ='appName'
     // The path where resolved dependencies will be stored
     // default value is "${rootProject}/vendor"
     vendorTargetDir = '/tmp/vendor'
