...
apply plugin: 'com.github.blindpirate.gogradle'
    ...
    fun testOneExample(dir: String, task: String, assertion: () -> Unit) {
        ...
        crossVersionTest {
            ...
            GradleRunner.create()
                    ...
                    .withArguments(listOf(task, "--info", "--stacktrace", "-Duser.dir=" + projectDir.absolutePath, "--no-daemon"))
    ...
    fun testMultiProject() {
        ...
        crossVersionTest {
            ...
            GradleRunner.create()
                    .withProjectDir(projectDir)
                    .withArguments(listOf("build", "--info", "--no-daemon"))
                    .withGradleVersion(it)
                    .forwardOutput()
                    .build()
    ...
    fun testFailedTest() {
        ...
        crossVersionTest {
            ...
            GradleRunner.create()
                    .withProjectDir(projectDir)
                    .withArguments(listOf("test", "--info", "--no-daemon"))
                    .withGradleVersion(it)
                    .forwardOutput()
                    .buildAndFail()
    ...
    fun testHandleTaskNameConflict() {
        ...
        crossVersionTest {
            ...
            GradleRunner.create()
                    .withProjectDir(projectDir)
                    .withArguments(listOf("goBuild", "--info", "-Dgogradle.alias=true", "--no-daemon"))
                    .withGradleVersion(it)
                    .forwardOutput()
                    .build()
        }
