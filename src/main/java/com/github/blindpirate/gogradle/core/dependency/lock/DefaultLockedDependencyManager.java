...
public class DefaultLockedDependencyManager implements LockedDependencyManager {
    ...
    @Inject
    public DefaultLockedDependencyManager(Project project, MapNotationParser mapNotationParser) {
    ...
    public void lock(Collection<? extends GolangDependency> flatDependencies) {
        List<Map<String, String>> notations = flatDependencies
    ...
    private Map<String, String> toNotation(GolangDependency dependency) {
